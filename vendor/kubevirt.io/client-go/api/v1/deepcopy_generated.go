...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HotplugVolumeRequest) DeepCopyInto(out *HotplugVolumeRequest) {
	*out = *in
	if in.Volume != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HotplugVolumeRequest.
func (in *HotplugVolumeRequest) DeepCopy() *HotplugVolumeRequest {
	if in == nil {
		return nil
	}
	out := new(HotplugVolumeRequest)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VirtualMachineInstanceStatus) DeepCopyInto(out *VirtualMachineInstanceStatus) {
	*out = *in
	...
	if in.HotpluggedVolumes != nil {
		in, out := &in.HotpluggedVolumes, &out.HotpluggedVolumes
