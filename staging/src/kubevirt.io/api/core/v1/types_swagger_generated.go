...
func (VirtualMachineInstanceMigrationState) SwaggerDoc() map[string]string {
	return map[string]string{
		...
		"sourceVirtualMachineInstanceUid": "The source VirtualMachineInstance UID",
		"targetVirtualMachineInstanceUid": "The target VirtualMachineInstance UID",
...
func (VirtualMachineInstanceMigrationSpec) SwaggerDoc() map[string]string {
	return map[string]string{
		...
		"nodeAntiAffinity": "Optional if operation is target, this is when migrating inside the same cluster but a different namespace.",
	}
}
